...
{
	partial class dailybillingreport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(dailybillingreport));
			...
			this.tsGo = new System.Windows.Forms.ToolStrip();
			...
			this.dgvctotal = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.dgvctotal)).BeginInit();
			...
			this.dtpDate.Location = new System.Drawing.Point(73, 3);
			...
			this.gcdly.Location = new System.Drawing.Point(12, 33);
			this.gcdly.Name = "gcdly";
			this.gcdly.Size = new System.Drawing.Size(813, 405);
			this.gcdly.TabIndex = 313;
			this.gcdly.Text = "Daily Biling Report";
			this.gcdly.Paint += new System.Windows.Forms.PaintEventHandler(this.gcdly_Paint);
			// 
			// xtc1
			// 
			this.xtc1.Location = new System.Drawing.Point(2, 23);
			this.xtc1.Name = "xtc1";
			this.xtc1.SelectedTabPage = this.xtall;
			this.xtc1.Size = new System.Drawing.Size(809, 379);
			...
			this.dgv.Size = new System.Drawing.Size(805, 305);
			this.dgv.TabIndex = 306;
			// 
			// User
			// 
			this.User.HeaderText = "Account No.";
			this.User.Name = "User";
			this.User.ReadOnly = true;
			// 
			// cName
			// 
			this.cName.HeaderText = "Consumer Name";
			...
			this.Discount.HeaderText = "S.C.Disc";
			...
			this.pepyrs.DefaultCellStyle = dataGridViewCellStyle9;
			...
			this.dgvt.Anchor = System.Windows.Forms.AnchorStyles.Left;
			...
			this.dgvt.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle10;
			...
			this.dgvt.Location = new System.Drawing.Point(0, 308);
			this.dgvt.Name = "dgvt";
			this.dgvt.ReadOnly = true;
			this.dgvt.RowHeadersWidth = 15;
			this.dgvt.ScrollBars = System.Windows.Forms.ScrollBars.Horizontal;
			this.dgvt.Size = new System.Drawing.Size(809, 43);
			...
			this.dataGridViewTextBoxColumn4.HeaderText = "Rtype";
			...
			this.dataGridViewTextBoxColumn5.HeaderText = "Arrears";
			...
			this.dataGridViewTextBoxColumn6.HeaderText = "Reading";
			...
			this.dataGridViewTextBoxColumn7.HeaderText = "CumUsed";
			...
			// tsGo
			// 
			this.tsGo.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.tsGo.Dock = System.Windows.Forms.DockStyle.None;
			this.tsGo.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
			this.tsGo.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.btnGo});
			this.tsGo.Location = new System.Drawing.Point(152, 2);
			this.tsGo.Name = "tsGo";
			this.tsGo.Size = new System.Drawing.Size(45, 25);
			this.tsGo.TabIndex = 317;
			this.tsGo.TabStop = true;
			this.tsGo.Text = "Go Menu";
			// 
			// btnGo
			// 
			...
			this.dgvc.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle22;
			...
			this.dgvc.DefaultCellStyle = dataGridViewCellStyle26;
			this.dgvc.Location = new System.Drawing.Point(12, 443);
			this.dgvc.Name = "dgvc";
			this.dgvc.ReadOnly = true;
			this.dgvc.RowHeadersWidth = 15;
			this.dgvc.Size = new System.Drawing.Size(484, 132);
			this.dgvc.TabIndex = 318;
			// 
			// dataGridViewTextBoxColumn16
			// 
			this.dataGridViewTextBoxColumn16.HeaderText = "Zone";
			...
			// 
			this.dataGridViewTextBoxColumn17.HeaderText = "Book";
			...
			// 
			this.dataGridViewTextBoxColumn18.HeaderText = "Classification";
			...
			this.dataGridViewTextBoxColumn20.HeaderText = "CuMUsed";
			...
			this.dataGridViewTextBoxColumn23.HeaderText = "BillAmt";
			...
			this.dataGridViewTextBoxColumn27.HeaderText = "Count";
			...
			// dgvctotal
			// 
			this.dgvctotal.AllowUserToAddRows = false;
			...
			this.dgvctotal.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle27;
			this.dgvctotal.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dgvctotal.ColumnHeadersVisible = false;
			this.dgvctotal.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
			...
			this.dgvctotal.Enabled = false;
			this.dgvctotal.Location = new System.Drawing.Point(12, 577);
			this.dgvctotal.Name = "dgvctotal";
			this.dgvctotal.ReadOnly = true;
			this.dgvctotal.RowHeadersWidth = 15;
			this.dgvctotal.Size = new System.Drawing.Size(484, 25);
			this.dgvctotal.TabIndex = 319;
			// 
			// dataGridViewTextBoxColumn21
			// 
			this.dataGridViewTextBoxColumn21.HeaderText = "Zone";
			...
			// 
			this.dataGridViewTextBoxColumn22.HeaderText = "Book";
			...
			this.dataGridViewTextBoxColumn24.HeaderText = "Classification";
			...
			this.dataGridViewTextBoxColumn26.HeaderText = "CuMUsed";
			...
			this.dataGridViewTextBoxColumn28.HeaderText = "BillAmt";
			...
			this.dataGridViewTextBoxColumn29.HeaderText = "Count";
			...
			this.Controls.Add(this.tsGo);
			this.Controls.Add(this.gcdly);
			this.Controls.Add(this.Label1);
			this.Controls.Add(this.dtpDate);
			this.MaximizeBox = false;
			this.MinimizeBox = false;
			this.Name = "dailybillingreport";
			...
			this.tsGo.ResumeLayout(false);
			this.tsGo.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvc)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dgvctotal)).EndInit();
		...
		internal System.Windows.Forms.ToolStrip tsGo;
		...
		private System.Windows.Forms.DataGridView dgvctotal;
