namespace bcsys.Forms.EntryForms
{
    partial class consearch
    {
        ...
        private void InitializeComponent()
        {
			...
			this.custstat = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.dgvConsumer.CellFormatting += new System.Windows.Forms.DataGridViewCellFormattingEventHandler(this.dgvConsumer_CellFormatting);
			// 
			// tsMenu
			// 
			...
			this.label5.Text = "Color Light Pink and Red - Disconnected";
			// 
			...
			// custstat
			// 
			this.custstat.HeaderText = "custstat";
			this.custstat.Name = "custstat";
			this.custstat.ReadOnly = true;
			this.custstat.Visible = false;
			// 
			// consearch
			// 
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn custstat;
	}
}